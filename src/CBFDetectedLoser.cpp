...
bool CBFDetectedLoser::init() {
	...
	bg->setContentSize({2020.f, 50.0f});
	...
	titleLabel->setPosition({8.0f, 36.0f});
	...
	bodyLabelDynamic->setPosition({8.0f, 20.0f});
	...
	bodyLabelStatic->setPosition({8.0f, bodyLabelDynamic->getPositionY() - 10.0f});
	...
	if (Utils::getBool("canonYPosition")) this->setPositionY(24.f);
